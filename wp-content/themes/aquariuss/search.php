            ...
            <div class="col-lg-9 col-sm-12">
                <div class="row">
                    <div class="col-lg-12 col-sm-12" data-aos="fade-up">
                        <h5 class="pyt-5 mb-3"><?php printf(pll__('Search Results for: %s', 'Translate'), esc_html($query)); ?></h5>
                    </div>
                </div>
                <div class="row mtm-08">
                    <?php
                        ...
                        if($search_query->have_posts()) : 
                            ...
                            echo '<p>'.pll__("No results found. Please try again with different keywords.", "Translate").'</p>';
                        endif;
                        wp_reset_postdata();
                    ?>
