...
<div class="wrap mjp-dashboard">
    ...
    <div id="welcome-panel" class="welcome-panel" style="padding:0px 10px">
      ...
      <marquee width="50%"> <p class="text-center chao-mung" style="color:#e74c3c;font-weight: bold;margin:0px">Chào mừng bạn đến với hệ thống quản trị website</p></marquee>
    </div>
