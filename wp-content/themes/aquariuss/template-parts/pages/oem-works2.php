    ...
    <div class="container">
        <div class="col-lg-12">
            <div class="info-item-large">
                <div class="desc-box text-left ptm-0">
    ...
    <div class="container">
        <div class="row gx-6 justify-content-center">
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="info-item-large">
                    <div class="desc-box short-line-2 pl-40 ptm-0 text-left">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="row g-2">
                    <?php
                        ...
                        if ($images) {
                            foreach ($images as $index => $image) { $j++; ?>
                                <div class="col-4" data-aos="fade-up" data-aos-delay="<?php echo $j; ?>00">
                                    <div class="item-grid">
                                        <a href="<?php echo esc_url($image['url']); ?>" data-lightbox="<?php echo esc_attr($image['alt']); ?>">
                                            <div class="item-inner" style="background-image: url('<?php echo esc_url($image['sizes']['medium']); ?>');"></div>
                                        </a>
                                    </div>
                                </div>
                    <?php
...
<section id="section-4" class="pt-5 pb-3">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="info-item-large-2">
                    <div class="desc-box ptm-0 text-left">
                        <h3 class="title-big fw-400 fs-38 pb-2" data-aos="fade-up" data-aos-delay="100"><?php echo get_field('title_3'); ?></h3>
...
<section id="section-5" class="pt-3 pb-5">
    <div class="container pt-2 scroll-x">
        <div class="row w-fit-content gx-3 space-mb justify-center">
            <?php
                ...
                ?>
                <div class="col item-work" data-aos="fade-up" data-aos-delay="<?php echo $i; ?>00">
                    <div class="align-center inner-work pointer">
                        ...
                        <div class="description-work" style="padding-left: 0;padding-right: 0;">
                            <?php echo $desc; ?>
                        </div>
                    </div>
                </div>
...
<section id="section-6" class="py-3">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="info-item-large">
                    <div class="desc-box text-left short-line-2 pl-40 ptm-0">
                        <h3 class="title-big fw-400 fs-38 pb-2" data-aos="fade-up" data-aos-delay="100"><?php echo get_field('title_4'); ?></h3>
                        <div class="detail-box-large" data-aos="fade-up" data-aos-delay="200">
                            <?php echo get_field('description_4'); ?>
                        </div>
                    </div>
                </div>
            </div>
