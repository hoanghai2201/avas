    ...
    <div class="container">
        <div class="row gx-6 justify-content-center">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="row g-2">
                    <img src="<?php echo esc_url(get_field('gallery')['url']); ?>" alt="<?php echo esc_attr(get_field('gallery')['alt']); ?>" />
                </div>
            </div>
        </div>
    </div>
            ...
            <?php
                ...
                <div class="col item-work" data-aos="fade-up" data-aos-delay="<?php echo $i; ?>00">
                    <div class="align-center inner-work pointer">
                        ...
                        <div class="head-work">
                            <h3><a title="<?php echo $title; ?>"><?php echo nl2br($title); ?></a></h3>
                        </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', () => {
        const titles = document.querySelectorAll('.head-work');
        let maxHeight = 0;
        ...
        // Áp dụng chiều cao lớn nhất cho tất cả title
        titles.forEach(title => {
