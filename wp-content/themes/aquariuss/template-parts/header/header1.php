                    ...
                    foreach ($menu_items as $item) {
                        if ($item->menu_item_parent == 0) {
                            ...
                            if ($has_submenu) {
                                ...
                                echo '<h5>'.esc_html($title).'<i class="bi bi-chevron-right"></i></h5>';
                                echo '</div>';

                                $count = 0; // Biến đếm số lượng menu item trong nhóm
                                echo '<div class="col-md-2 col-sm-4"><ul class="list-unstyled">';
                                foreach ($menu_items as $sub_item) {
                                    if ($sub_item->menu_item_parent == $item->ID) {
                                        ...
                                        $count++;
                                        if ($count % 3 == 0) {
                                            echo '</div><div class="col-md-2 col-sm-4"><ul class="list-unstyled">';
                                        }
                                    }
                                }
                                echo '</ul></div>';
